...
/**
 * lp3 — Book marketing campaign landing page.
 *
 * Design: "Marketing.png" (_figma-ref/landing-pages/).
 *
 ...
 * data/landing.php under the 'marketing' key. Editing this page means editing
